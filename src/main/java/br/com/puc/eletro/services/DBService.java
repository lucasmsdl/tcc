...
public class DBService {
	...
	@Autowired
	private ItemPedidoRepository itemPedidoRepitory;
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "lucasmsdl@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "juquinhabsb@gmail.com", "75784815334", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("33334455", "88990011"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Aptp 303", "Jardim", "38220843", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "23977012", cli2, c2);
		...
		itemPedidoRepitory.saveAll(Arrays.asList(ip1, ip2, ip3));
	}
}
